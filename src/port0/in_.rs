...
#[doc = "Port 0 Input Bit 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum P0_A {
    #[doc = "0: The input level of P0.x is 0."]
    VALUE1,
    #[doc = "1: The input level of P0.x is 1."]
    VALUE2,
}
