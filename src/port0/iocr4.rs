...
impl PC7_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, PC7_A> {
        ...
        match self.bits {
            ...
            21 => Val(PC7_A::VALUE14),
            22 => Val(PC7_A::VALUE15),
            23 => Val(PC7_A::VALUE16),
            24 => Val(PC7_A::VALUE17),
            25 => Val(PC7_A::VALUE18),
            26 => Val(PC7_A::VALUE19),
            27 => Val(PC7_A::VALUE20),
            28 => Val(PC7_A::VALUE21),
            29 => Val(PC7_A::VALUE22),
            30 => Val(PC7_A::VALUE23),
            31 => Val(PC7_A::VALUE24),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `VALUE1`"]
...
impl<'a> PC7_W<'a> {
    ...
    #[inline(always)]
    pub fn value19(self) -> &'a mut W {
        self.variant(PC7_A::VALUE19)
    }
    #[doc = "Output Open Drain - Alternate output function 3"]
    #[inline(always)]
    pub fn value20(self) -> &'a mut W {
        self.variant(PC7_A::VALUE20)
    }
    #[doc = "Output Open Drain - Alternate output function 4"]
    #[inline(always)]
    pub fn value21(self) -> &'a mut W {
        self.variant(PC7_A::VALUE21)
    }
    #[doc = "Output Open Drain - Alternate output function 5"]
    #[inline(always)]
    pub fn value22(self) -> &'a mut W {
        self.variant(PC7_A::VALUE22)
    }
    #[doc = "Output Open Drain - Alternate output function 6"]
    #[inline(always)]
    pub fn value23(self) -> &'a mut W {
        self.variant(PC7_A::VALUE23)
    }
    #[doc = "Output Open Drain - Alternate output function 7"]
    #[inline(always)]
    pub fn value24(self) -> &'a mut W {
        self.variant(PC7_A::VALUE24)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
