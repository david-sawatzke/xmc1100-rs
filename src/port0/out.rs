...
#[doc = "Port 0 Output Bit 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum P0_A {
    #[doc = "0: The output level of P0.x is 0."]
    VALUE1,
    #[doc = "1: The output level of P0.x is 1."]
    VALUE2,
}
...
impl<'a> P0_W<'a> {
    ...
    #[doc = "The output level of P0.x is 0."]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(P0_A::VALUE1)
    }
    #[doc = "The output level of P0.x is 1."]
    #[inline(always)]
