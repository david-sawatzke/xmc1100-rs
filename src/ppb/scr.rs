...
pub enum SLEEPONEXIT_A {
    ...
    VALUE1,
    #[doc = "1: Enter sleep, or deep sleep, on return from an ISR to Thread mode."]
    VALUE2,
}
...
impl<'a> SLEEPONEXIT_W<'a> {
    ...
    #[doc = "Enter sleep, or deep sleep, on return from an ISR to Thread mode."]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 2 - Low Power Sleep Mode"]
    #[inline(always)]
