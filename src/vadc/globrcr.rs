...
#[doc = "Register GLOBRCR `reset()`'s with value 0x0100_0000"]
...
pub enum DRCTR_A {
    ...
    VALUE1,
    #[doc = "1: Accumulate 2 result values"]
    VALUE2,
    #[doc = "2: Accumulate 3 result values"]
    VALUE3,
    #[doc = "3: Accumulate 4 result values"]
    VALUE4,
}
...
impl DRCTR_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, DRCTR_A> {
        ...
        match self.bits {
            ...
            1 => Val(DRCTR_A::VALUE2),
            2 => Val(DRCTR_A::VALUE3),
            3 => Val(DRCTR_A::VALUE4),
            i => Res(i),
        }
    }
...
impl<'a> DRCTR_W<'a> {
    ...
    #[doc = "Accumulate 2 result values"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut W {
        self.variant(DRCTR_A::VALUE2)
    }
    #[doc = "Accumulate 3 result values"]
    #[inline(always)]
    pub fn value3(self) -> &'a mut W {
        self.variant(DRCTR_A::VALUE3)
    }
    #[doc = "Accumulate 4 result values"]
    #[inline(always)]
    pub fn value4(self) -> &'a mut W {
        self.variant(DRCTR_A::VALUE4)
    }
