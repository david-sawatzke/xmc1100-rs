...
#[doc = "Port 2 Pin Power Save Bit 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS0_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
    #[doc = "1: Pin Power Save of P2.x is enabled."]
    VALUE2,
}
...
impl<'a> PPS0_W<'a> {
    ...
    #[doc = "Pin Power Save of P2.x is disabled."]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
        self.variant(PPS0_A::VALUE1)
    }
    #[doc = "Pin Power Save of P2.x is enabled."]
    #[inline(always)]
...
#[doc = "Port 2 Pin Power Save Bit 1\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS1_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 2\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS2_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 3\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS3_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 4\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS4_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 5\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS5_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 6\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS6_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 7\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS7_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 8\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS8_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 9\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS9_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 10\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS10_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
...
#[doc = "Port 2 Pin Power Save Bit 11\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PPS11_A {
    #[doc = "0: Pin Power Save of P2.x is disabled."]
    VALUE1,
